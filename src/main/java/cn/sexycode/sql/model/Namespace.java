...
public class Namespace {
	...
	public Namespace(Database database, Name name) {
		...
		this.name = name;
		this.physicalName = new Name(null, null);
...
//	 * @param logicalTableName The logical table name
	...
	public Table createTable(Identifier logicalTableName, boolean isAbstract) {
		...
		final Identifier physicalTableName = database.getPhysicalNamingStrategy().toPhysicalTableName( logicalTableName, database.getEnvironment() );
