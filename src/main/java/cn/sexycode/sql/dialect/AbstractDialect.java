...
*/
    ...
    public static Dialect getDialect() throws DialectException {
        return instantiateDialect(Environment.getEnvironment().getProperties().getProperty(Environment.DIALECT));
    }
  ...
  /*  @Deprecated
    ...
    @Override
    public String getTypeName(int sqlTypeCode, int length, int precision, int scale) {
        return null;
    }
